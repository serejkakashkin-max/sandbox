...
CA следует этой схеме: исходный проект остается автономным внутри `CA/`, а корневой `wsgi.py` динамически загружает его Python-пакет и монтирует на `/ca/zpi-assistant`.
